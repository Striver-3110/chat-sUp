...
const Login = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-w-96 mx-auto border rounded bg-[#1b243e]'>
      <img
        src='chatbg.jpg'
 ...
 input-bordered h-10'
          ...
          <div>
            <button
              className='btn btn-block btn-sm mt-2 bg-[#154e65] border-white'
              disabled={loading}
            >
              {loading ? (
